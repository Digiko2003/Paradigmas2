...
public class FrmPersonas extends JFrame {
    ...
    private void llenarTabla(){
        ...
        personasMilenarias = personas.stream()
                .filter(p -> p.getAñoNacimiento() > 2000)
    ...
    private void initComponents(){
        ...
        JButton btnCoeficiente5y10 = new JButton("Peronas con coeficiente entre 5 y 10");
        ...
        btnLosRobles.addActionListener(e -> {
            personas = personas.stream()
                    ...
                    .collect(Collectors.toList());
            llenarTabla();
            setTitle("peronas con apellido Robles");
        });
